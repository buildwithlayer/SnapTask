...
export interface CustomFieldCreateRequest {
     ...
     * @type {string}
     * @memberof CustomFieldCreateRequest
     */
    readonly gid?: string;
    /**
     ...
     * @memberof CustomFieldCreateRequest
     */
    readonly type?: CustomFieldCreateRequestTypeEnum;
    /**
     ...
     * @memberof CustomFieldCreateRequest
     */
    readonly representationType?: CustomFieldCreateRequestRepresentationTypeEnum;
    /**
     ...
     * @memberof CustomFieldCreateRequest
     */
    format?: CustomFieldCreateRequestFormatEnum;
    /**
     ...
     * @memberof CustomFieldCreateRequest
     */
    customLabelPosition?: CustomFieldCreateRequestCustomLabelPositionEnum | null;
    /**
     ...
     * @memberof CustomFieldCreateRequest
     */
    readonly asanaCreatedField?: CustomFieldCreateRequestAsanaCreatedFieldEnum | null;
    /**
     ...
     * @memberof CustomFieldCreateRequest
     */
    resourceSubtype: CustomFieldCreateRequestResourceSubtypeEnum;
}
 ...
 * @export
 */
export const CustomFieldCreateRequestTypeEnum = {
    Text: 'text',
    Enum: 'enum',
...
export type CustomFieldCreateRequestTypeEnum = typeof CustomFieldCreateRequestTypeEnum[keyof typeof CustomFieldCreateRequestTypeEnum];

/**
 * @export
 */
export const CustomFieldCreateRequestRepresentationTypeEnum = {
    Text: 'text',
    Enum: 'enum',
    MultiEnum: 'multi_enum',
    Number: 'number',
...
export type CustomFieldCreateRequestRepresentationTypeEnum = typeof CustomFieldCreateRequestRepresentationTypeEnum[keyof typeof CustomFieldCreateRequestRepresentationTypeEnum];

/**
 * @export
 */
export const CustomFieldCreateRequestFormatEnum = {
    Currency: 'currency',
...
export type CustomFieldCreateRequestFormatEnum = typeof CustomFieldCreateRequestFormatEnum[keyof typeof CustomFieldCreateRequestFormatEnum];

/**
 * @export
 */
export const CustomFieldCreateRequestCustomLabelPositionEnum = {
    Prefix: 'prefix',
    Suffix: 'suffix'
} as const;
export type CustomFieldCreateRequestCustomLabelPositionEnum = typeof CustomFieldCreateRequestCustomLabelPositionEnum[keyof typeof CustomFieldCreateRequestCustomLabelPositionEnum];

/**
 * @export
 */
export const CustomFieldCreateRequestAsanaCreatedFieldEnum = {
...
export type CustomFieldCreateRequestAsanaCreatedFieldEnum = typeof CustomFieldCreateRequestAsanaCreatedFieldEnum[keyof typeof CustomFieldCreateRequestAsanaCreatedFieldEnum];

/**
 * @export
 */
export const CustomFieldCreateRequestResourceSubtypeEnum = {
    Text: 'text',
    Enum: 'enum',
    MultiEnum: 'multi_enum',
    Number: 'number',
...
export type CustomFieldCreateRequestResourceSubtypeEnum = typeof CustomFieldCreateRequestResourceSubtypeEnum[keyof typeof CustomFieldCreateRequestResourceSubtypeEnum];


/**
 * Check if a given object implements the CustomFieldCreateRequest interface.
 */
export function instanceOfCustomFieldCreateRequest(value: object): value is CustomFieldCreateRequest {
    if (!('workspace' in value) || value['workspace'] === undefined) return false;
    if (!('resourceSubtype' in value) || value['resourceSubtype'] === undefined) return false;
    return true;
}

export function CustomFieldCreateRequestFromJSON(json: any): CustomFieldCreateRequest {
    return CustomFieldCreateRequestFromJSONTyped(json, false);
}

export function CustomFieldCreateRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): CustomFieldCreateRequest {
    if (json == null) {
        return json;
    }
    return {
        ...
        'resourceSubtype': json['resource_subtype'],
    };
}

export function CustomFieldCreateRequestToJSON(json: any): CustomFieldCreateRequest {
    return CustomFieldCreateRequestToJSONTyped(json, false);
}

export function CustomFieldCreateRequestToJSONTyped(value?: Omit<CustomFieldCreateRequest, 'gid'|'resource_type'|'type'|'enabled'|'representation_type'|'display_value'|'is_global_to_workspace'|'asana_created_field'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
