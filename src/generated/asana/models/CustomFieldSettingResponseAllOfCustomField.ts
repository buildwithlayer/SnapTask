 ...
 * 
 * @export
 * @interface CustomFieldSettingResponseAllOfCustomField
 */
export interface CustomFieldSettingResponseAllOfCustomField {
    /**
     * Globally unique identifier of the resource, as a string.
     * @type {string}
     * @memberof CustomFieldSettingResponseAllOfCustomField
     */
    readonly gid?: string;
    /**
     ...
     * @memberof CustomFieldSettingResponseAllOfCustomField
     */
    readonly type?: CustomFieldSettingResponseAllOfCustomFieldTypeEnum;
    /**
     ...
     * @memberof CustomFieldSettingResponseAllOfCustomField
     */
    readonly representationType?: CustomFieldSettingResponseAllOfCustomFieldRepresentationTypeEnum;
    /**
     ...
     * @memberof CustomFieldSettingResponseAllOfCustomField
     */
    format?: CustomFieldSettingResponseAllOfCustomFieldFormatEnum;
    /**
     ...
     * @memberof CustomFieldSettingResponseAllOfCustomField
     */
    customLabelPosition?: CustomFieldSettingResponseAllOfCustomFieldCustomLabelPositionEnum | null;
    /**
     ...
     * @memberof CustomFieldSettingResponseAllOfCustomField
     */
    readonly asanaCreatedField?: CustomFieldSettingResponseAllOfCustomFieldAsanaCreatedFieldEnum | null;
    /**
     ...
     * @memberof CustomFieldSettingResponseAllOfCustomField
     */
    privacySetting?: CustomFieldSettingResponseAllOfCustomFieldPrivacySettingEnum;
    /**
     ...
     * @memberof CustomFieldSettingResponseAllOfCustomField
     */
    defaultAccessLevel?: CustomFieldSettingResponseAllOfCustomFieldDefaultAccessLevelEnum;
    /**
     ...
     * @memberof CustomFieldSettingResponseAllOfCustomField
     */
    readonly resourceSubtype?: CustomFieldSettingResponseAllOfCustomFieldResourceSubtypeEnum;
}
 ...
 * @export
 */
export const CustomFieldSettingResponseAllOfCustomFieldTypeEnum = {
    Text: 'text',
    Enum: 'enum',
...
export type CustomFieldSettingResponseAllOfCustomFieldTypeEnum = typeof CustomFieldSettingResponseAllOfCustomFieldTypeEnum[keyof typeof CustomFieldSettingResponseAllOfCustomFieldTypeEnum];

/**
 * @export
 */
export const CustomFieldSettingResponseAllOfCustomFieldRepresentationTypeEnum = {
    Text: 'text',
    Enum: 'enum',
    MultiEnum: 'multi_enum',
    Number: 'number',
...
export type CustomFieldSettingResponseAllOfCustomFieldRepresentationTypeEnum = typeof CustomFieldSettingResponseAllOfCustomFieldRepresentationTypeEnum[keyof typeof CustomFieldSettingResponseAllOfCustomFieldRepresentationTypeEnum];

/**
 * @export
 */
export const CustomFieldSettingResponseAllOfCustomFieldFormatEnum = {
    Currency: 'currency',
...
export type CustomFieldSettingResponseAllOfCustomFieldFormatEnum = typeof CustomFieldSettingResponseAllOfCustomFieldFormatEnum[keyof typeof CustomFieldSettingResponseAllOfCustomFieldFormatEnum];

/**
 * @export
 */
export const CustomFieldSettingResponseAllOfCustomFieldCustomLabelPositionEnum = {
    Prefix: 'prefix',
    Suffix: 'suffix'
} as const;
export type CustomFieldSettingResponseAllOfCustomFieldCustomLabelPositionEnum = typeof CustomFieldSettingResponseAllOfCustomFieldCustomLabelPositionEnum[keyof typeof CustomFieldSettingResponseAllOfCustomFieldCustomLabelPositionEnum];

/**
 * @export
 */
export const CustomFieldSettingResponseAllOfCustomFieldAsanaCreatedFieldEnum = {
...
export type CustomFieldSettingResponseAllOfCustomFieldAsanaCreatedFieldEnum = typeof CustomFieldSettingResponseAllOfCustomFieldAsanaCreatedFieldEnum[keyof typeof CustomFieldSettingResponseAllOfCustomFieldAsanaCreatedFieldEnum];

/**
 * @export
 */
export const CustomFieldSettingResponseAllOfCustomFieldPrivacySettingEnum = {
    PublicWithGuests: 'public_with_guests',
    Public: 'public',
    Private: 'private'
} as const;
export type CustomFieldSettingResponseAllOfCustomFieldPrivacySettingEnum = typeof CustomFieldSettingResponseAllOfCustomFieldPrivacySettingEnum[keyof typeof CustomFieldSettingResponseAllOfCustomFieldPrivacySettingEnum];

/**
 * @export
 */
export const CustomFieldSettingResponseAllOfCustomFieldDefaultAccessLevelEnum = {
    Admin: 'admin',
    Editor: 'editor',
    User: 'user'
} as const;
export type CustomFieldSettingResponseAllOfCustomFieldDefaultAccessLevelEnum = typeof CustomFieldSettingResponseAllOfCustomFieldDefaultAccessLevelEnum[keyof typeof CustomFieldSettingResponseAllOfCustomFieldDefaultAccessLevelEnum];

/**
 * @export
 */
export const CustomFieldSettingResponseAllOfCustomFieldResourceSubtypeEnum = {
    Text: 'text',
    Enum: 'enum',
    MultiEnum: 'multi_enum',
    Number: 'number',
...
export type CustomFieldSettingResponseAllOfCustomFieldResourceSubtypeEnum = typeof CustomFieldSettingResponseAllOfCustomFieldResourceSubtypeEnum[keyof typeof CustomFieldSettingResponseAllOfCustomFieldResourceSubtypeEnum];


/**
 * Check if a given object implements the CustomFieldSettingResponseAllOfCustomField interface.
 */
export function instanceOfCustomFieldSettingResponseAllOfCustomField(value: object): value is CustomFieldSettingResponseAllOfCustomField {
    return true;
}

export function CustomFieldSettingResponseAllOfCustomFieldFromJSON(json: any): CustomFieldSettingResponseAllOfCustomField {
    return CustomFieldSettingResponseAllOfCustomFieldFromJSONTyped(json, false);
}

export function CustomFieldSettingResponseAllOfCustomFieldFromJSONTyped(json: any, ignoreDiscriminator: boolean): CustomFieldSettingResponseAllOfCustomField {
    if (json == null) {
        return json;
    }
    return {
        ...
        'isValueReadOnly': json['is_value_read_only'] == null ? undefined : json['is_value_read_only'],
        'createdBy': json['created_by'] == null ? undefined : UserCompactFromJSON(json['created_by']),
        'peopleValue': json['people_value'] == null ? undefined : ((json['people_value'] as Array<any>).map(UserCompactFromJSON)),
...
export function CustomFieldSettingResponseAllOfCustomFieldToJSON(json: any): CustomFieldSettingResponseAllOfCustomField {
    return CustomFieldSettingResponseAllOfCustomFieldToJSONTyped(json, false);
}

export function CustomFieldSettingResponseAllOfCustomFieldToJSONTyped(value?: Omit<CustomFieldSettingResponseAllOfCustomField, 'gid'|'resource_type'|'type'|'enabled'|'representation_type'|'display_value'|'is_global_to_workspace'|'asana_created_field'|'resource_subtype'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'is_value_read_only': value['isValueReadOnly'],
        'created_by': UserCompactToJSON(value['createdBy']),
        'people_value': value['peopleValue'] == null ? undefined : ((value['peopleValue'] as Array<any>).map(UserCompactToJSON)),
