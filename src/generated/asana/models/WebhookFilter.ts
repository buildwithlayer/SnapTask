...
/**
 * Check if a given object implements the WebhookFilter interface.
 */
export function instanceOfWebhookFilter(value: object): value is WebhookFilter {
    return true;
}

export function WebhookFilterFromJSON(json: any): WebhookFilter {
    return WebhookFilterFromJSONTyped(json, false);
}

export function WebhookFilterFromJSONTyped(json: any, ignoreDiscriminator: boolean): WebhookFilter {
    if (json == null) {
        return json;
    }
    return {
...
export function WebhookFilterToJSON(json: any): WebhookFilter {
    return WebhookFilterToJSONTyped(json, false);
}

export function WebhookFilterToJSONTyped(value?: WebhookFilter | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
