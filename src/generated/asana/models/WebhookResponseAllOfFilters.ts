 ...
 * @export
 * @interface WebhookResponseAllOfFilters
 */
export interface WebhookResponseAllOfFilters {
     ...
     * @type {string}
     * @memberof WebhookResponseAllOfFilters
     */
    resourceType?: string;
    /**
...
/**
 * Check if a given object implements the WebhookResponseAllOfFilters interface.
 */
export function instanceOfWebhookResponseAllOfFilters(value: object): value is WebhookResponseAllOfFilters {
    return true;
}

export function WebhookResponseAllOfFiltersFromJSON(json: any): WebhookResponseAllOfFilters {
    return WebhookResponseAllOfFiltersFromJSONTyped(json, false);
}

export function WebhookResponseAllOfFiltersFromJSONTyped(json: any, ignoreDiscriminator: boolean): WebhookResponseAllOfFilters {
    if (json == null) {
        return json;
    }
    return {
...
export function WebhookResponseAllOfFiltersToJSON(json: any): WebhookResponseAllOfFilters {
    return WebhookResponseAllOfFiltersToJSONTyped(json, false);
}

export function WebhookResponseAllOfFiltersToJSONTyped(value?: WebhookResponseAllOfFilters | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
