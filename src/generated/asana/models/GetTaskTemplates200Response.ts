...
import type { TaskTemplateCompact } from './TaskTemplateCompact.js';
import {
    TaskTemplateCompactFromJSON,
    TaskTemplateCompactFromJSONTyped,
    TaskTemplateCompactToJSON,
    TaskTemplateCompactToJSONTyped,
} from './TaskTemplateCompact.js';
...
export function GetTaskTemplates200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetTaskTemplates200Response {
    ...
    return {
        ...
        'data': json['data'] == null ? undefined : ((json['data'] as Array<any>).map(TaskTemplateCompactFromJSON)),
    };
}
...
export function GetTaskTemplates200ResponseToJSONTyped(value?: GetTaskTemplates200Response | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'data': value['data'] == null ? undefined : ((value['data'] as Array<any>).map(TaskTemplateCompactToJSON)),
    };
}
